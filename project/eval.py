...
def main():
    ...
    print("\n--- Test Set Evaluation ---")
    y_true_test, y_pred_test, test_volume_ids = _infer_with_ids(model, test_loader, device, args.model_type, dataset)
    ...
    y_true_all, y_pred_all, all_volume_ids = _infer_with_ids(model, all_loader, device, args.model_type, dataset)
